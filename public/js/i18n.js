...
(function () {
  const STRINGS = {
    en: {
      ...
      analyzer_title: 'Innovative Clinical Analysis', upload_title: 'Upload Your Photo', upload_text: 'Face, hands, arms, legs — any body part!',
    ...
    zh: {
      ...
      analyzer_title: '創新臨床分析', upload_title: '上傳照片', upload_text: '面部、手、手臂、腿——任何部位！',
