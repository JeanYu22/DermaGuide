...
(function () {
  const STRINGS = {
    en: {
      ...
      chat_title: 'Chat with Lily', chat_ph: 'Type your message…',
      ...
      lily_greeting: "Hi, I'm Lily, your AI skincare guide. Ready to analyze your skin?", start_skin_analysis: 'Start Skin Analysis',
      top_picks: 'Top Picks for You', recent_skin_health: 'Recent Skin Health', loading_products: 'Loading products…',
    ...
    zh: {
      ...
      chat_title: '與 Lily 對話', chat_ph: '輸入您的訊息…',
      ...
      lily_greeting: '你好，我是 Lily，你的 AI 護膚顧問。準備好分析你的肌膚了嗎？', start_skin_analysis: '開始肌膚分析',
      top_picks: '為你精選', recent_skin_health: '近期膚況', loading_products: '產品載入中…',
